...
class Racas implements IRacas{
	 ...
	 * o nome da ra�a conforme o sexo do personagem. 
	 */
	function dgd_raca($sexo){
		if($sexo == 'Masculino'):
			$racas = array("Humano","An�o","Elfo","Gnomo","Meio elfo","Meio orc","Halfling");
		elseif($sexo == 'Feminino'):
			$racas = array("Humana","An�","Elfa","Gnoma","Meio elfa","Meio orc","Halfling");
		endif;
	 ...
	 * varia com a ra�a do personagem.
	 * @param raca = a ra�a do personagem
	 */
	...
	function dgd_altura($raca){
		...
		$racas = array("Humano","An�o","Elfo","Gnomo","Meio elfo","Meio orc","Halfling","Humana","An�","Elfa","Gnoma","Meio elfa");
	 ...
	 * ra�a do personagem passada por parametro
	 * @raca = ra�a do personagem
	 */
	 ...
	 * a ra�a do personagem que � passada por parametro.
	 * @param $raca = ra�a do personagem
	 */
