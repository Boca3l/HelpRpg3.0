...
/*
 * Classe Atributos
 * Esta classe prover m�todos para gera��o de 
...
class Atributos{
	 ...
	 * Prover a simula��o de uma rolagem de 4 dados de 6 faces
	 * descartando o menor n�mero.
	 * @param nivel = N�vel do personagem
	 */
